/**
 * 该例程将执行/show_person服务，服务数据类型learning_launch::PersonSrv
 */
...
#include "learning_launch/CommandTurtleSrv.h"
...
public:
    ...
    bool CommandTurtleCallback(learning_launch::CommandTurtleSrv::Request &req,
                               learning_launch::CommandTurtleSrv::Response &res);
...
// service回调函数，输入参数req，输出参数res
bool RosNode::CommandTurtleCallback(learning_launch::CommandTurtleSrv::Request &req,
                                    learning_launch::CommandTurtleSrv::Response &res)
{
    // 显示请求数据
